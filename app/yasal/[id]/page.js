...
export default function LegalPage() {
  ...
  // URL id'sine göre hangi çeviri bloğunun alınacağını belirle
  ...
  const titles = {
    ...
    cookies: text.nav?.contact === 'Contact' ? 'Cookie Policy' : text.nav?.contact === 'Контакты' ? 'Политика использования файлов cookie' : 'Çerez Politikası'
  };
