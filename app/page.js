...
export default function Home() {
  ...
  const featNames = { 
    profile: "Bookcy Profili", market: "Pazaryeri Listeleme", team: "Ekip Yönetimi", 
    booking: "Online Randevu", app: "Müşteri Uygulaması", marketing: "Pazarlama Araçları", 
    calendar: "Takvim & Planlama", crm: "Müşteri Yönetimi", boost: "Öne Çık", stats: "İstatistik & Raporlar" 
  };
  
  const featDesc = { 
    profile: "İşletmenizin dijital vitrinini saniyeler içinde oluşturun.", 
    market: "Bookcy kullanan binlerce aktif müşteriye doğrudan ulaşın.", 
    team: "Personelinizin çalışma saatlerini kolayca yönetin.", 
    booking: "Müşterilerinizin 7/24 randevu almasını sağlayın.", 
    app: "Müşterilerinize özel mobil uygulama konforu sunun.", 
    marketing: "Doğru zamanda doğru mesajı gönderin.", 
    calendar: "Akıllı dijital takvim ile çakışmaları önleyin.", 
    crm: "Müşteri geçmişini güvenle saklayın.", 
    boost: "Aramalarda üst sıralara çıkın.", 
    stats: "Anlık ve net raporlarla kazancınızı görün." 
  };
                                      ...
                                      {['profile', 'market', 'team'].map(key => (
                                        <li key={key}>
                                          <button onClick={() => goToFeature(key)} className="hover:text-[#E8622A] cursor-pointer transition-colors flex items-center gap-2 bg-transparent border-none text-slate-600 p-0">
                                            <ChevronRight size={14} className="text-[#E8622A]"/> {featNames[key]}
                                          </button>
                                        </li>
                                      ))}
                                    </ul>
      ...
      <main className="flex-1 w-full relative z-10 min-h-[80vh] mt-[72px]">
        ...
        {step === 'services' && (
            <div className="w-full">
                ...
                <section className="bg-white py-10 md:py-24 px-6 md:px-8 border-b border-slate-200 section-padding">
                  <div className="max-w-6xl mx-auto flex flex-col md:flex-row justify-between items-start md:items-end mb-6 md:mb-10 gap-4">
                    <div><div className="text-[11px] font-black text-[#E8622A] uppercase tracking-[0.3em] mb-2">Kategoriler</div><div className="text-2xl md:text-4xl font-black text-[#2D1B4E] tracking-tight">Bugün ne yaptırmak istersiniz?</div></div>
               ...
               {recommendedShops.length > 0 && (
                  <section className="bg-slate-50 py-10 md:py-24 px-6 md:px-8 border-t border-slate-200 section-padding">
                    <div className="max-w-6xl mx-auto flex flex-col md:flex-row justify-between items-start md:items-end mb-6 md:mb-10 gap-4">
                      <div><div className="text-[11px] font-black text-[#E8622A] uppercase tracking-[0.3em] mb-2">Öne Çıkanlar</div><div className="text-2xl md:text-4xl font-black text-[#2D1B4E] tracking-tight">Kıbrıs'ta Bu Hafta 🔥</div></div>
              ...
              <section className="bg-white py-10 md:py-24 px-6 md:px-8 border-t border-slate-200 section-padding">
                <div className="max-w-6xl mx-auto text-center">
                  <div className="text-[#E8622A] font-black text-sm tracking-widest uppercase mb-4">Nasıl Çalışır?</div>
                  <div className="text-3xl md:text-5xl font-black text-[#2D1B4E] mb-10 md:mb-16 tracking-tight">4 Basit Adımda Randevun Hazır</div>
        ...
        {step === 'why_bookcy' && (
            <div className="w-full bg-[#FAF7F2] pb-24 pt-10 md:pt-16">
                <div className="bg-[#2D1B4E] pt-20 md:pt-24 pb-20 md:pb-24 px-6 text-center border-b border-slate-800"><span className="bg-white/10 text-white px-4 py-1.5 rounded-full text-[10px] font-black uppercase tracking-[0.2em] mb-6 inline-block">Farkı Keşfedin</span><h1 className="text-3xl md:text-6xl font-black uppercase tracking-tighter text-white mb-6">Neden <span className="text-[#E8622A]">Bookcy</span> Kullanıyorlar?</h1><p className="text-base md:text-lg text-slate-300 max-w-2xl mx-auto px-4">Kişisel bakım yolculuğunuzun en güvenilir ortağıyız.</p></div>
                <div className="max-w-6xl mx-auto px-6 -mt-10"><div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8"><div className="bg-white p-8 rounded-3xl shadow-xl border border-slate-200"><div className="w-16 h-16 bg-orange-50 text-[#E8622A] rounded-2xl flex items-center justify-center mb-6"><Crown size={32}/></div><h3 className="font-black text-xl text-[#2D1B4E] mb-3">Öncü Platform</h3><p className="text-slate-500 font-medium leading-relaxed">Kıbrıs’ta ilk ve öncü randevu platformlarından biri olarak, sektöre yön veriyoruz.</p></div><div className="bg-white p-8 rounded-3xl shadow-xl border border-slate-200"><div className="w-16 h-16 bg-blue-50 text-blue-500 rounded-2xl flex items-center justify-center mb-6"><Grid size={32}/></div><h3 className="font-black text-xl text-[#2D1B4E] mb-3">Entegre Sistem</h3><p className="text-slate-500 font-medium leading-relaxed">Farklı sektörleri tek çatı altında toplayarak kapsamlı deneyim sunuyoruz.</p></div><div className="bg-white p-8 rounded-3xl shadow-xl border border-slate-200"><div className="w-16 h-16 bg-green-50 text-green-500 rounded-2xl flex items-center justify-center mb-6"><Users size={32}/></div><h3 className="font-black text-xl text-[#2D1B4E] mb-3">Gerçek Müşteri</h3><p className="text-slate-500 font-medium leading-relaxed">İşletmelere gerçek müşteri kazandıran aktif bir trafik sağlıyoruz.</p></div><div className="bg-white p-8 rounded-3xl shadow-xl border border-slate-200"><div className="w-16 h-16 bg-purple-50 text-purple-500 rounded-2xl flex items-center justify-center mb-6"><Smartphone size={32}/></div><h3 className="font-black text-xl text-[#2D1B4E] mb-3">Üst Düzey Arayüz</h3><p className="text-slate-500 font-medium leading-relaxed">Sade, hızlı ve kullanıcı dostu modern bir arayüz sunuyoruz.</p></div><div className="bg-white p-8 rounded-3xl shadow-xl border border-slate-200"><div className="w-16 h-16 bg-pink-50 text-pink-500 rounded-2xl flex items-center justify-center mb-6"><TrendingUp size={32}/></div><h3 className="font-black text-xl text-[#2D1B4E] mb-3">Maksimum Kazanç</h3><p className="text-slate-500 font-medium leading-relaxed">İşletmeler için adil, şeffaf ve komisyonsuz modelimiz ile gelirinizi katlamanızı sağlıyoruz.</p></div><div className="bg-white p-8 rounded-3xl shadow-xl border border-slate-200"><div className="w-16 h-16 bg-teal-50 text-teal-500 rounded-2xl flex items-center justify-center mb-6"><MessageSquare size={32}/></div><h3 className="font-black text-xl text-[#2D1B4E] mb-3">Gelişmiş Otomasyon</h3><p className="text-slate-500 font-medium leading-relaxed">Yüksek performanslı altyapımızla yakında eklenecek SMS ve gelişmiş bildirim sistemleri.</p></div></div><div className="mt-10 md:mt-16 text-center"><button onClick={() => {setShowRegister(true); window.scrollTo(0,0);}} className="bg-[#E8622A] hover:bg-[#d4561f] text-white px-12 py-5 rounded-full font-black uppercase tracking-widest text-sm border-none cursor-pointer inline-flex items-center gap-2 shadow-lg">Hemen Aramıza Katıl <ArrowRight size={18}/></button></div></div>
            </div>
        )}

        {/* TÜM İŞLETMELER */}
        {step === 'all_shops' && (
            <div className="w-full max-w-[1400px] mx-auto pt-10 md:pt-24 px-6 md:px-8 pb-20">
                ...
                <div className="flex flex-col md:flex-row justify-between md:items-end mb-8 border-b border-slate-200 pb-4 gap-4"><h2 className="text-2xl md:text-3xl font-black uppercase text-[#2D1B4E] tracking-tight">Arama Sonuçları</h2><span className="text-sm font-bold text-[#E8622A] bg-orange-50 px-4 py-2 rounded-xl w-fit">{sortedShops.length} Mekan Bulundu</span></div>
        ...
        {step === 'shop_profile' && selectedShop && (
            <div className="w-full max-w-6xl mx-auto pt-10 md:pt-24 px-6 pb-20">
                ...
                <div className="mb-10 border-b border-slate-200 pb-8 px-2 md:px-6"><div className="flex flex-wrap items-center gap-3 mb-3"><h1 className="text-2xl md:text-4xl font-black uppercase text-[#2D1B4E] tracking-tight">{selectedShop.name}</h1>{(selectedShop.package === 'Premium Paket' || selectedShop.package === 'Premium') && <Gem size={28} className="text-yellow-500 fill-yellow-500"/>}</div><div className="flex flex-wrap items-center gap-4 text-xs font-bold text-slate-500 uppercase tracking-widest"><span className="text-[#E8622A] px-3 py-1.5 bg-orange-50 rounded-lg">{selectedShop.category}</span><span className="flex items-center gap-1"><MapPin size={14}/> {selectedShop.address || selectedShop.location}</span></div></div>
        ...
        {step === 'about' && (
            <div className="w-full bg-[#FAF7F2] pb-24 pt-10 md:pt-16"><div className="bg-[#2D1B4E] pt-20 md:pt-24 pb-24 md:pb-32 px-6 text-center"><span className="bg-white/10 text-white px-5 py-2 rounded-full text-[10px] font-black uppercase tracking-widest border border-white/20 mb-8 inline-block">Sektörün Dijital Devrimi</span><h1 className="text-3xl md:text-6xl font-black text-white mb-8 tracking-tight">İşletmeni Dijitale Taşı,<br/><span className="text-[#E8622A]">Kazancını Katla</span></h1><p className="text-base md:text-lg text-slate-300 max-w-2xl mx-auto font-medium leading-relaxed px-4">Kıbrıs’taki en iyi işletmeler randevularını Bookcy ile yönetiyor.</p></div><div className="max-w-[1200px] mx-auto px-6 -mt-10 md:-mt-16"><div className="bg-white p-8 md:p-16 rounded-[40px] shadow-2xl border border-slate-200 mb-16 md:mb-20 text-center relative overflow-hidden"><div className="absolute top-0 right-0 w-64 h-64 bg-orange-50 rounded-bl-full -z-10"></div><h2 className="text-sm font-black text-[#E8622A] uppercase tracking-[0.3em] mb-6 relative z-10">Biz Kimiz?</h2><p className="text-xl md:text-3xl text-[#2D1B4E] font-black leading-tight mb-8 relative z-10">Bookcy, Kıbrıs’ta kurulan ilk ve tek kapsamlı online randevu platformu olarak, işletmelerin dijital dönüşümünü hızlandırmak için geliştirilmiştir.</p><p className="text-base md:text-lg text-slate-500 font-medium mb-12 max-w-4xl mx-auto relative z-10 leading-relaxed">Güzellikten bakıma, spadan yaşam tarzı hizmetlerine kadar birçok sektörü tek çatı altında buluşturarak, hem işletmelere hem müşterilere yeni nesil bir deneyim sunuyoruz.</p><div className="bg-[#2D1B4E] text-white p-6 md:p-10 rounded-[32px] inline-block font-bold text-lg md:text-2xl shadow-2xl relative z-10 border border-slate-700 leading-relaxed">Biz sadece bir randevu sistemi değiliz <br/><span className="text-[#E8622A]">işletmelerin büyümesini sağlayan dijital altyapıyız.</span></div></div>
        ...
        {step === 'contact' && (
            <div className="w-full bg-[#FAF7F2] pb-24 pt-10 md:pt-16 relative z-0">
                <div className="bg-[#2D1B4E] pt-20 md:pt-24 pb-32 md:pb-40 px-6 text-center relative border-b border-slate-800 z-0">
                    <h1 className="text-3xl md:text-6xl font-black uppercase text-white mb-6 tracking-tight">BİZE ULAŞIN</h1>
                    <p className="text-base md:text-xl text-slate-300 max-w-xl mx-auto font-medium leading-relaxed">Sorularınız, destek talepleriniz veya sponsorluk görüşmeleri için bize her zaman ulaşabilirsiniz.</p>
                </div>
                <div className="max-w-[1100px] mx-auto px-6 -mt-16 md:-mt-24 relative z-10">
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
                        <div className="bg-white p-8 md:p-12 rounded-[40px] text-center shadow-2xl border border-slate-200 hover:-translate-y-2 transition-transform duration-300">
                            ...
                            <p className="text-sm md:text-base text-slate-500 mb-8 md:mb-10 font-medium leading-relaxed">Anında destek ve işletme başvuruları için bize yazın.</p>
                            <a href="https://wa.me/905555555555" target="_blank" className="block bg-[#25D366] hover:bg-green-600 text-white py-4 md:py-5 rounded-2xl font-black uppercase tracking-widest text-sm transition-colors no-underline shadow-[0_10px_25px_rgba(37,211,102,0.3)]">MESAJ GÖNDER</a>
                        </div>
                        <div className="bg-white p-8 md:p-12 rounded-[40px] text-center shadow-2xl border border-slate-200 hover:-translate-y-2 transition-transform duration-300">
                            ...
                            <p className="text-sm md:text-base text-slate-500 mb-8 md:mb-10 font-medium leading-relaxed">En yeni mekanları keşfedin ve bizi takip edin.</p>
                            <a href="https://instagram.com/bookcy" target="_blank" className="block bg-gradient-to-r from-[#833AB4] via-[#FD1D1D] to-[#F56040] hover:opacity-90 text-white py-4 md:py-5 rounded-2xl font-black uppercase tracking-widest text-sm transition-opacity no-underline shadow-[0_10px_25px_rgba(225,48,108,0.3)]">TAKİP ET</a>
                        </div>
                        <div className="bg-white p-8 md:p-12 rounded-[40px] text-center shadow-2xl border border-slate-200 hover:-translate-y-2 transition-transform duration-300">
                            ...
                            <p className="text-sm md:text-base text-slate-500 mb-8 md:mb-10 font-medium leading-relaxed">Kurumsal görüşmeler ve reklam teklifleri için.</p>
                            <a href="mailto:info@bookcy.co" className="block bg-[#2D1B4E] hover:bg-[#1a0f2e] text-white py-4 md:py-5 rounded-2xl font-black uppercase tracking-widest text-sm transition-colors no-underline shadow-[0_10px_25px_rgba(45,27,78,0.3)]">MAİL AT</a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        {step === 'feature_detail' && activeFeature && (<div className="w-full bg-[#FAF7F2] pb-24 pt-10 md:pt-16"><div className="bg-[#2D1B4E] pt-20 md:pt-24 pb-32 md:pb-40 px-6 text-center border-b border-slate-800"><h1 className="text-3xl md:text-5xl font-black text-white uppercase tracking-tight">{featNames[activeFeature]}</h1></div><div className="max-w-[800px] mx-auto px-6 -mt-16 md:-mt-24"><div className="bg-white p-8 md:p-16 rounded-[40px] shadow-2xl border border-slate-200 text-center"><div className="flex justify-center mb-8"><div className="w-20 h-20 md:w-24 md:h-24 bg-orange-50 rounded-full flex items-center justify-center">{featureIcons[activeFeature] || <Star size={40} className="text-[#E8622A]"/>}</div></div><h2 className="text-2xl md:text-3xl font-black text-[#2D1B4E] mb-6 uppercase tracking-widest">{featNames[activeFeature]}</h2><p className="text-base md:text-xl text-slate-500 leading-relaxed font-medium">{featDesc[activeFeature]}</p></div></div></div>)}
        {step === 'all_features' && (<div className="w-full bg-[#FAF7F2] pb-24 pt-10 md:pt-16"><div className="bg-[#2D1B4E] pt-20 md:pt-24 pb-32 md:pb-40 px-6 text-center"><h1 className="text-3xl md:text-6xl font-black text-white uppercase tracking-tight">Tüm Özellikler</h1></div><div className="max-w-[1200px] mx-auto px-6 -mt-16 md:-mt-24"><div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">{Object.keys(featNames).map(key => (<div key={key} onClick={() => goToFeature(key)} className="bg-white p-8 md:p-10 rounded-[32px] shadow-xl border border-slate-200 cursor-pointer hover:-translate-y-2 transition-all group"><div className="w-16 h-16 md:w-20 md:h-20 bg-slate-50 text-[#E8622A] rounded-2xl flex items-center justify-center mb-6 md:mb-8 group-hover:bg-orange-50 transition-colors">{featureIconsSmall[key]}</div><h3 className="font-black text-lg md:text-xl text-[#2D1B4E] mb-3 md:mb-4 uppercase tracking-widest">{featNames[key]}</h3><p className="text-sm md:text-base text-slate-500 font-medium leading-relaxed">{featDesc[key]}</p></div>))}</div></div></div>)}

        {/* YASAL SAYFALAR */}
        {['privacy', 'kvkk', 'terms', 'cookies'].includes(step) && (
            <div className="w-full bg-[#FAF7F2] pb-24 pt-10 md:pt-16"><div className="bg-white pt-16 md:pt-24 pb-16 md:pb-24 px-6 text-center border-b border-slate-200"><h1 className="text-2xl md:text-5xl font-black text-[#2D1B4E] uppercase tracking-tight">{step === 'privacy' ? 'Gizlilik Politikası' : step === 'kvkk' ? 'KVKK Aydınlatma Metni' : step === 'terms' ? 'Kullanım Şartları' : 'Çerez Politikası'}</h1><p className="text-xs md:text-sm font-bold text-slate-500 mt-6 uppercase tracking-widest bg-slate-50 inline-block px-4 py-2 rounded-lg">Son Güncelleme: 10 Nisan 2024</p></div><div className="max-w-4xl mx-auto mt-10 md:mt-16 bg-white p-8 md:p-20 rounded-[32px] md:rounded-[40px] border border-slate-200 text-slate-600 font-medium leading-relaxed shadow-xl"><div className="prose prose-slate max-w-none">
