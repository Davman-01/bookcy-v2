...
export default function Home() {
  ...
  return (
    <div className="w-full">
      ...
      {/* HERO BÖLÜMÜ - Masaüstünde rahatça nefes alması için paddingler artırıldı */}
      <section className="relative min-h-[100dvh] pt-[80px] w-full overflow-hidden flex flex-col items-center justify-between bg-[#1a0f2e]">
        ...
        {/* ANA İÇERİK - Masaüstünde boşluklar (mb-8, mb-12) ile genişletildi */}
        <div className="relative z-20 flex flex-col items-center justify-center flex-1 w-full max-w-[900px] mx-auto px-4 py-8 md:py-16 text-center">
          
          <div className="inline-flex items-center gap-2 bg-white/10 border border-white/20 rounded-full px-4 py-1.5 text-[10px] md:text-xs font-bold text-white/90 uppercase tracking-widest mb-4 md:mb-8 backdrop-blur-md shadow-lg">
          ...
          <p className="text-xs md:text-lg text-white/80 mb-6 md:mb-12 max-w-2xl mx-auto font-medium drop-shadow-md leading-relaxed px-2">
            {text.hero?.sub}
          </p>
          
          <form className="w-full bg-white rounded-[24px] md:rounded-[50px] p-1.5 md:p-3 shadow-2xl flex flex-col md:flex-row gap-2 mx-auto max-w-[800px] mb-6 md:mb-10 relative z-30" onSubmit={handleHeroSearch}>
        ...
        {/* İSTATİSTİKLER - Masaüstünde alt tarafa nefes aldırıldı */}
