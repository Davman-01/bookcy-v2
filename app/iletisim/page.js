...
export default function Contact() {
  ...
  return (
    <div className="w-full bg-[#FAF7F2] pb-24 pt-10 md:pt-16 relative z-0">
      ...
      {/* 4'LÜ İLETİŞİM KARTLARI */}
      <div className="max-w-[1200px] mx-auto px-6 -mt-16 md:-mt-24 relative z-10">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8">
          
          {/* WHATSAPP */}
          <div className="bg-white p-8 md:p-10 rounded-[40px] text-center shadow-2xl border border-slate-200 hover:-translate-y-2 transition-transform duration-300 flex flex-col h-full">
            <div className="w-16 h-16 md:w-20 md:h-20 bg-green-50 text-[#25D366] rounded-full flex items-center justify-center mx-auto mb-6"><MessageCircle size={32}/></div>
            <h3 className="font-black text-lg md:text-xl text-[#2D1B4E] mb-3 uppercase tracking-widest">WhatsApp</h3>
            <p className="text-xs md:text-sm text-slate-500 mb-8 font-medium leading-relaxed flex-1">{text.wp1}</p>
          ...
          {/* INSTAGRAM */}
          <div className="bg-white p-8 md:p-10 rounded-[40px] text-center shadow-2xl border border-slate-200 hover:-translate-y-2 transition-transform duration-300 flex flex-col h-full">
            <div className="w-16 h-16 md:w-20 md:h-20 bg-pink-50 text-[#E1306C] rounded-full flex items-center justify-center mx-auto mb-6"><InstagramIcon size={32}/></div>
            <h3 className="font-black text-lg md:text-xl text-[#2D1B4E] mb-3 uppercase tracking-widest">Instagram</h3>
            <p className="text-xs md:text-sm text-slate-500 mb-8 font-medium leading-relaxed flex-1">{text.ig1}</p>
            {/* Resmi Instagram Linki */}
          ...
          {/* TIKTOK */}
          <div className="bg-white p-8 md:p-10 rounded-[40px] text-center shadow-2xl border border-slate-200 hover:-translate-y-2 transition-transform duration-300 flex flex-col h-full">
            <div className="w-16 h-16 md:w-20 md:h-20 bg-slate-100 text-black rounded-full flex items-center justify-center mx-auto mb-6"><TiktokIcon size={32}/></div>
            <h3 className="font-black text-lg md:text-xl text-[#2D1B4E] mb-3 uppercase tracking-widest">TikTok</h3>
            <p className="text-xs md:text-sm text-slate-500 mb-8 font-medium leading-relaxed flex-1">{text.tt1 || "Eğlenceli ve bilgilendirici içeriklerimiz için TikTok'ta bize katılın!"}</p>
            {/* Resmi TikTok Linki */}
          ...
          {/* E-POSTA */}
          <div className="bg-white p-8 md:p-10 rounded-[40px] text-center shadow-2xl border border-slate-200 hover:-translate-y-2 transition-transform duration-300 flex flex-col h-full">
            <div className="w-16 h-16 md:w-20 md:h-20 bg-blue-50 text-blue-500 rounded-full flex items-center justify-center mx-auto mb-6"><Mail size={32}/></div>
            <h3 className="font-black text-lg md:text-xl text-[#2D1B4E] mb-3 uppercase tracking-widest">E-Posta</h3>
            <p className="text-xs md:text-sm text-slate-500 mb-8 font-medium leading-relaxed flex-1">{text.mail1}</p>
